...
public class AllOurApiName {

    public static final String videoallevent = "event/getvideoeventsbycategoryyear/?cid=1";
    public static final String videoallbypeople = "bypeople/getvideoallappposts/?cid=1";
