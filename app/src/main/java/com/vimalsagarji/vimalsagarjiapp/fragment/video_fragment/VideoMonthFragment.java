...
public class VideoMonthFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (sharedpreferance.getId().equalsIgnoreCase("")) {
            mainurl = "http://www.aacharyavimalsagarsuriji.com/vimalsagarji/video/getvideobycategorymonth/?cid="+video_cat_id+"&page=";

        } else {
            mainurl = "http://www.aacharyavimalsagarsuriji.com/vimalsagarji/video/getvideobycategorymonth/?cid="+video_cat_id+"&uid=" + sharedpreferance.getId() + "&page=";
        }
