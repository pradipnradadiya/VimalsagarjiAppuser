...
public class VideoTodayFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (sharedpreferance.getId().equalsIgnoreCase("")) {
            mainurl = CommonUrl.Main_url+"video/getvideobycategorytoday/?cid=" + video_cat_id + "&page=";

        } else {
            mainurl = CommonUrl.Main_url+"video/getvideobycategorytoday/?cid=" + video_cat_id + "&uid=" + sharedpreferance.getId() + "&page=";
        }
