...
public class QuestionWeekFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (sharedpreferance.getId().equalsIgnoreCase("")) {
            mainurl = "http://www.aacharyavimalsagarsuriji.com/vimalsagarji/questionanswer/viewallappquesweek/?page=";

        } else {
            mainurl = "http://www.aacharyavimalsagarsuriji.com/vimalsagarji/questionanswer/viewallappquesweek/?uid=" + sharedpreferance.getId() + "&page=";
        }
