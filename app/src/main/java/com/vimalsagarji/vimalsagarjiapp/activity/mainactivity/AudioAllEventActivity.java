...
public class AudioAllEventActivity extends AppCompatActivity {
...
//    private ImageView img_search;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        linearLayoutManager = new LinearLayoutManager(AudioAllEventActivity.this);
        recycleviewVideo = (RecyclerView) findViewById(R.id.recycleviewVideo);
        recycleviewVideo.setLayoutManager(linearLayoutManager);

        audioAllAdapter = new AudioAllAdapter(AudioAllEventActivity.this, audioAllItems);
...
//                                                                 Log.e("flag-Scroll", flag_scroll + "");
                                                         ...
                                                         if (!loading && (totalItemCount - visibleItemCount) <= (firstVisibleItem + visibleThreshold)) {
                                                             ...
                                                             if (CommonMethod.isInternetConnected(AudioAllEventActivity.this)) {
    ...
    private class GetAllAudio extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            responseJson = CommonMethod.getStringResponse(AllOurCommonUrl.commonUrl + AllOurApiName.audioallevent + "&page=" + page_count + "&psize=15");
            return responseJson;
        }
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    ...
                    audioAllItems.add(new AudioAllItem(title, "eventaudio/"+audio));
                }
