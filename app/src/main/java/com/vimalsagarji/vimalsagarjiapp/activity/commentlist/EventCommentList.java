...
public class EventCommentList extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        sharedpreferance = new Sharedpreferance(EventCommentList.this);
        findId();
        img_send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (TextUtils.isEmpty(edit_comment.getText().toString())) {
                    ...
                    if (CommonMethod.isInternetConnected(EventCommentList.this)) {
                        new CommentPost().execute(edit_comment.getText().toString());
                    } else {
                        Toast.makeText(EventCommentList.this, R.string.internet, Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
    ...
    private void findId() {
        linearLayoutManager = new LinearLayoutManager(EventCommentList.this);
    ...
    private class CommentPost extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            loadingProgressDialog = KProgressHUD.create(EventCommentList.this)
        ...
        protected String doInBackground(String... params) {
            ...
            responseJSON = CommonMethod.postStringResponse(postCommentURL, nameValuePairs, EventCommentList.this);
            return responseJSON;
...
//            nameValuePairs.add(new BasicNameValuePair("eid", params[0]));
            responseJSON = CommonMethod.getStringResponse("http://www.aacharyavimalsagarsuriji.com/vimalsagarji_qa/event/getallcomments/?page=" + page_count + "&psize=30&eid=" + id);
            return responseJSON;
        }
        ...
        protected void onPostExecute(String s) {
            ...
            if (recyclerView_comments != null) {
                commentAdapter = new CommentAdapter(EventCommentList.this, commentLists);
