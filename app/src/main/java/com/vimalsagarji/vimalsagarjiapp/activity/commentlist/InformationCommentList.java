...
public class InformationCommentList extends AppCompatActivity {
    ...
    private class CommentPost extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            responseJSON = CommonMethod.postStringResponse("http://www.grapes-solutions.com/vimalsagarji/info/comment/", nameValuePairs, InformationCommentList.this);
            return responseJSON;
    ...
    private class CommentList extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            responseJSON = CommonMethod.postStringResponse("http://www.grapes-solutions.com/vimalsagarji/info/getallappcomments/?page=" + page_count + "&psize=30", nameValuePairs, InformationCommentList.this);
            return responseJSON;
        }
