...
public class ByPeopleCommentList extends AppCompatActivity {
    ...
    private class CommentPost extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            responseJSON = CommonMethod.postStringResponse("http://www.aacharyavimalsagarsuriji.com/vimalsagarji_qa/bypeople/comment/", nameValuePairs, ByPeopleCommentList.this);
    ...
    private class CommentList extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            responseJSON = CommonMethod.postStringResponse("http://www.aacharyavimalsagarsuriji.com/vimalsagarji_qa/bypeople/getallappcomments/?page=" + page_count + "&psize=30", nameValuePairs, ByPeopleCommentList.this);
            return responseJSON;
        }
