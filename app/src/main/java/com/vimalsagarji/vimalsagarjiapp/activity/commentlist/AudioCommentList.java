...
public class AudioCommentList extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        sharedpreferance = new Sharedpreferance(AudioCommentList.this);
        findId();
        img_send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (TextUtils.isEmpty(edit_comment.getText().toString())) {
                    ...
                    if (CommonMethod.isInternetConnected(AudioCommentList.this)) {
                        new CommentPost().execute(edit_comment.getText().toString());
                    } else {
                        Toast.makeText(AudioCommentList.this, R.string.internet, Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
    ...
    private void findId() {
        linearLayoutManager = new LinearLayoutManager(AudioCommentList.this);
    ...
    private class CommentPost extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            loadingProgressDialog = KProgressHUD.create(AudioCommentList.this)
        ...
        protected String doInBackground(String... params) {
            ...
            responseJSON = CommonMethod.postStringResponse("http://www.aacharyavimalsagarsuriji.com/vimalsagarji_qa/audio/comment/", nameValuePairs, AudioCommentList.this);
    ...
    private class CommentList extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            responseJSON = CommonMethod.postStringResponse("http://www.aacharyavimalsagarsuriji.com/vimalsagarji_qa/audio/getallappcomments/?page=" + page_count + "&psize=30", nameValuePairs, AudioCommentList.this);
            return responseJSON;
        }
        ...
        protected void onPostExecute(String s) {
            ...
            if (recyclerView_comments != null) {
                commentAdapter = new CommentAdapter(AudioCommentList.this, commentLists);
