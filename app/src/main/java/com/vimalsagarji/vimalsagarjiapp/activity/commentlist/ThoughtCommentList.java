...
public class ThoughtCommentList extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        id = intent.getExtras().getString("thoughtid");
        click_action = intent.getExtras().getString("click_action");
        sharedpreferance = new Sharedpreferance(ThoughtCommentList.this);
        findId();
        img_send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (TextUtils.isEmpty(edit_comment.getText().toString())) {
                    ...
                    if (CommonMethod.isInternetConnected(ThoughtCommentList.this)) {
                        new CommentPost().execute(edit_comment.getText().toString());
                    } else {
                        Toast.makeText(ThoughtCommentList.this, R.string.internet, Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
    ...
    private void findId() {
        linearLayoutManager = new LinearLayoutManager(ThoughtCommentList.this);
    ...
    private class CommentPost extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            loadingProgressDialog = KProgressHUD.create(ThoughtCommentList.this)
        ...
        protected String doInBackground(String... params) {
            ...
            responseJSON = CommonMethod.postStringResponse("http://www.aacharyavimalsagarsuriji.com/vimalsagarji_qa/thought/comment/", nameValuePairs, ThoughtCommentList.this);
            return responseJSON;
        }
    ...
    private class CommentList extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            responseJSON = CommonMethod.postStringResponse("http://www.aacharyavimalsagarsuriji.com/vimalsagarji_qa/thought/getallappcomments/?page=" + page_count + "&psize=30", nameValuePairs, ThoughtCommentList.this);
            return responseJSON;
        }
        ...
        protected void onPostExecute(String s) {
            ...
            if (recyclerView_comments != null) {
                commentAdapter = new CommentAdapter(ThoughtCommentList.this, commentLists);
