...
public class VideoCommentList extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        sharedpreferance = new Sharedpreferance(VideoCommentList.this);
        findId();
        img_send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (TextUtils.isEmpty(edit_comment.getText().toString())) {
                    ...
                    if (CommonMethod.isInternetConnected(VideoCommentList.this)) {
                        new CommentPost().execute(edit_comment.getText().toString());
                    } else {
                        Toast.makeText(VideoCommentList.this, R.string.internet, Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
    ...
    private void findId() {
        linearLayoutManager = new LinearLayoutManager(VideoCommentList.this);
    ...
    private class CommentPost extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            loadingProgressDialog = KProgressHUD.create(VideoCommentList.this)
        ...
        protected String doInBackground(String... params) {
            ...
            responseJSON = CommonMethod.postStringResponse("http://www.grapes-solutions.com/vimalsagarji/video/comment/", nameValuePairs, VideoCommentList.this);
    ...
    private class CommentList extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            responseJSON = CommonMethod.postStringResponse("http://www.grapes-solutions.com/vimalsagarji/video/getallappcomments/?page=" + page_count + "&psize=30", nameValuePairs, VideoCommentList.this);
            return responseJSON;
        }
        ...
        protected void onPostExecute(String s) {
            ...
            if (recyclerView_comments != null) {
                commentAdapter = new CommentAdapter(VideoCommentList.this, commentLists);
